...
public class SettingsPageViewModelTests
{
    ...
    public void RestoreDefaultSettings_ActionWasCanceled_ShouldNotRestoreDefaultSettings()
    {
        ...
        // assert
        _settingsServiceMock
            .Verify(x => x.Set(Constants.Settings.IsDarkThemeEnabled, AppSettings.DefaultIsDarkThemeEnabled), Times.Never);
        _settingsServiceMock
        ...
        _alertServiceMock
            .Verify(x => x.DisplayAlertAsync(AppResources.SettingsPage_Title, Constants.Messages.SettingsRestored), Times.Never);
    }
    ...
    public void RestoreDefaultSettings_ActionWasNotCanceled_ShouldRestoreDefaultSettings()
    {
        ...
        // assert
        _settingsServiceMock
            .Verify(x => x.Set(Constants.Settings.IsDarkThemeEnabled, AppSettings.DefaultIsDarkThemeEnabled), Times.Once);
        _settingsServiceMock
        ...
        _alertServiceMock
            .Verify(x => x.DisplayAlertAsync(AppResources.SettingsPage_Title, Constants.Messages.SettingsRestored), Times.Once);
    }
    ...
    public async Task DisplayUnsavedChangesDialog_ShouldShowDialogWarningAboutUnsavedChanges()
    {
        ...
        // assert
        _alertServiceMock
            .Verify(x => x.DisplayConfirmAsync(AppResources.SettingsPage_Title, Constants.Messages.UnsavedChanges), Times.Once);
    }
}